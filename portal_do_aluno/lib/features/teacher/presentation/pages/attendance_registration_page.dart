...
class AttendanceRegistrationPage extends StatefulWidget {
  ...
  @override
  State<AttendanceRegistrationPage> createState() => _AttendanceRegistrationPageState();
}

class _AttendanceRegistrationPageState extends State<AttendanceRegistrationPage> {
  ...
  Future<void> salvarFrequencia() async {
    ...
    final frequenciaProvider = context.read<AttendanceProvider>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: SaveButton(salvarconteudo: salvarFrequencia),
      ),
